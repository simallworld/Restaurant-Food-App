  ...
  return (
    <div className="flex items-center justify-center ">
      ...
      >
        ...
        {
         loading ? (
            <Button disabled className="bg-orange w-full hover:bg-hoverOrange"><Loader2 className="mr-2 h-4 w-4 animate-spin"/> Please wait</Button>
         ) : (
            <Button className="bg-orange hover:bg-hoverOrange" type="submit">Send Reset Link</Button>
         )
        }
        {loading ? (
