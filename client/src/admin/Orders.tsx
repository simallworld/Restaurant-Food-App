  ...
  return (
    <div className="max-w-6xl mx-auto py-10 px-6">
      ...
      <div className="space-y-8">
         ...
         <div className="flex flex-col md:flex-row justify-between items-start sm:items-center bg-white dark:bg-gray-800 shadow-lg rounded-xl p-6 sm:p-8 border-gray-800 dark:border-gray-700">
            <div className="flex-1 mb-6 sm:mb-0">
               <h1 className="text-xl font-semibold text-gray-800 dark:text-gray-100">Kanpuria Cook</h1>
               <p className="text-gray-600 dark:text-gray-400 mt-2">
                  <span className="font-semibold">Address: {" "}</span>
                  Bishanpura, Sector-58 Noida</p>
               <p className="text-gray-600 dark:text-gray-400 mt-2">
